...
const O2_DATABASE = [
  ...
  },
  {
    ...
    content: "Geçmişte tamamlanmış eylemler için kullanılır. Terimlere boğulmadan 3 adımlık basit bir mantıkla çözülebilir.",
    details: [
      "A) Temel Mantık (Basitçe): Geçmişte bitmiş, belirli bir zamanda olan olaylar için kullanılır. (Zaman kelimeleri: yesterday, last week/month/year, ago, in 2020, when I was a child...)",
      "B) 3 Form (Sadece 3!): Olumlu -> Fiilin 2. hali. | Olumsuz -> didn't + fiil 1. hali. | Soru -> Did + özne + fiil 1. hali?",
      "C) 🔴 Karmaşa Noktası: \"did\" gelince fiil ASLA değişmez! \"did\" zaten geçmişi taşıyor. \"Did he went?\" veya \"I didn't played\" YANLIŞTIR. Doğrusu: \"Did he go?\" ve \"I didn't play.\" Anahtar: did varsa, fiil her zaman 1. hali!"
    ],
    examples: [],
    related_word_ids: []
  },
  ...
  },
  {
    ...
    content: "Konuşma dilinde karşımızdakinden onay almak için cümlenin sonuna eklenen kısa sorulardır. Türkçedeki \"değil mi?\" ifadesini karşılar ve karmaşık kurallar yerine 4 basit adımla bulunabilir.",
    details: [
      "Adım 1: Cümlede \"miş/mış\" (geçmiş) var mı? Fiilde \"-ed\" varsa (played) veya değişik şekilde geçmişse (went, ate) tag'de \"didn't\" kullan. (He finished... -> didn't he?)",
      "Adım 2: Cümlede \"emir kipi\" gibi olumsuz şeyler var mı? (don't, doesn't, isn't, can't...) Varsa tag'de olumlu yap. (doesn't -> does, aren't -> are)",
      "Adım 3: Cümlede \"hal\" fiili var mı? (am, is, are, was, were). Varsa aynısının zıttını kullan (is -> isn't). 🔴 TEK İSTİSNA: Cümlede \"I am\" varsa tag her zaman \"aren't I?\" olur (ezberle!).",
      "Adım 4: Hiçbiri yoksa? (Normal cümle: I play, She likes). He/She/It (tekil) için tag'de \"doesn't\", I/You/We/They (çoğul) için \"don't\" kullan. (She likes tea... -> doesn't she?)"
    ],
    examples: [],
    related_word_ids: []
  },
